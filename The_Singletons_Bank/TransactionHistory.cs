...
namespace The_Singletons_Bank
{
    internal class TransactionHistory
    {
        ...
        public TransactionHistory(int isAInternalTransfer1, int senderId1, string senderCurrency1, int recipientId1, string recipientCurrency1, decimal amount1, string createdDate1)
        {
